...
public class Main {
    public static void main(String[] args) {
        ...
        Book bookCompare1 = new Book("Незнайка на Луне", author1, 1965);

        Book book2 = new Book("Унесённые ветром", author2, 1936);
        Book bookCompare2 = new Book("Унесённые ветром", author2, 1936);
        System.out.println(book1);
        System.out.println(book1.hashCode());
//        book1.setPublication(2022);
//        System.out.println(book1);
        System.out.println(book1.hashCode() == bookCompare1.hashCode());
...
//        System.out.println(book2);
        System.out.println(book2.hashCode()==bookCompare2.hashCode());
